...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ isCartOpen }) => {
  return (
    <div 
      className={`fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[9999] flex items-center gap-3 group print:hidden transition-all duration-300 ${
